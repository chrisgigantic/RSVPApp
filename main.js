document.addEventListener('DOMContentLoaded', function() {
    ...
    const guestList = [
        ...
        { name: "Nida Inso", seats: 5, table: "Principal Sponsors", additionalInfo: "Attending with: Jonathan Inso, Sheena Inso, Pernie Lepiten, Sophia Lepiten, John Paul Inso, Carlisle Inso. Note: Group members assigned to different tables (Principal Sponsors, Perseverance)." },
    ...
    function handleCheckButtonClick() {
        ...
        if (matchedGuests.length > 0) {
            ...
            showIdentityConfirmation(matchedGuests[selectedGuestIndex], name);
        } else {
